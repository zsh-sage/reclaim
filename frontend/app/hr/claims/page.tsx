...
import { Plus, Search, ChevronUp, ChevronDown, FileText, Shield, Archive, Pencil, Trash2, ArrowLeft } from 'lucide-react';
...
export default function PolicyStudio() {
      ...
      <div className="flex-1 flex flex-col relative overflow-hidden w-full h-full bg-surface text-on-surface">
        ...
        <div className="flex-1 flex flex-col p-6 max-w-7xl mx-auto w-full min-h-0">
          <div className="mb-6 flex flex-wrap items-center gap-4 shrink-0">
            ...
            <h2 className="font-headline text-[2rem] leading-tight font-bold text-on-surface tracking-[-0.02em]">Remote Work Policy v2.4</h2>
          </div>
  ...
  return (
    <div className="flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden bg-surface text-on-surface font-body antialiased selection:bg-primary-container selection:text-on-primary-container">
      <div className="layout-container flex h-full grow flex-col">
        <div className="flex flex-1 justify-center">
          <div className="layout-content-container flex flex-col w-full flex-1">
            <main className="flex-1 flex flex-col p-8 lg:p-12 gap-8 max-w-[1440px] mx-auto w-full">
              {/* Header Section */}
              <div className="flex flex-wrap items-center justify-between gap-6">
                <div>
                  <h1 className="font-headline text-5xl font-extrabold leading-tight tracking-tight text-on-surface mb-2">Policy Studio</h1>
                  <p className="text-on-surface-variant text-lg">Manage, review, and distribute company guidelines.</p>
                </div>
              ...
              <div className="bg-surface-container-lowest/60 backdrop-blur-xl rounded-[2rem] p-8 flex flex-col gap-8 shadow-[0_12px_60px_rgba(44,47,49,0.06)] overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                  ...
                  <div className="flex items-center bg-surface-container-low rounded-xl p-1 gap-1">
                    <button className="px-6 py-2 rounded-lg bg-surface-container-lowest shadow-[0_4px_20px_rgba(44,47,49,0.04)] text-primary font-medium text-sm transition-all">Active</button>
                    <button className="px-6 py-2 rounded-lg text-on-surface-variant hover:text-on-surface hover:bg-surface-container-highest/50 font-medium text-sm transition-all">Impending</button>
                    <button className="px-6 py-2 rounded-lg text-on-surface-variant hover:text-on-surface hover:bg-surface-container-highest/50 font-medium text-sm transition-all">Expired</button>
                  </div>
                </div>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="border-b border-surface-container-highest">
                        <th className="py-4 px-6 font-headline font-semibold text-sm text-on-surface-variant uppercase tracking-wider">Name</th>
                        <th className="py-4 px-6 font-headline font-semibold text-sm text-on-surface-variant uppercase tracking-wider cursor-pointer group">
                        ...
                        <th className="py-4 px-6 font-headline font-semibold text-sm text-on-surface-variant uppercase tracking-wider">Status</th>
                        <th className="py-4 px-6 font-headline font-semibold text-sm text-on-surface-variant uppercase tracking-wider text-right">Action</th>
                      </tr>
                    </thead>
                    <tbody className="font-body text-on-surface">
                      {/* Row 1 */}
                      <tr className="group hover:bg-surface-container-highest/30 transition-colors border-b border-surface-container-highest/50 last:border-0">
                        <td className="py-5 px-6">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-base">Remote Work Guidelines</p>
                              <p className="text-sm text-on-surface-variant mt-0.5">V2.4 • IT & HR</p>
                            </div>
                          </div>
                        </td>
                        <td className="py-5 px-6 text-sm">Oct 24, 2023</td>
                        <td className="py-5 px-6">
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-[#e6f4ea] text-[#137333]">Active</span>
                        </td>
                        <td className="py-5 px-6 text-right">
                          <button onClick={() => setEditingPolicy('remote-work')} className="p-2 rounded-lg text-outline-variant hover:text-primary hover:bg-primary-container/10 transition-colors">
                            <Pencil size={20} />
                          </button>
                        </td>
                      </tr>
                      ...
                      <tr className="group hover:bg-surface-container-highest/30 transition-colors border-b border-surface-container-highest/50 last:border-0">
                        <td className="py-5 px-6">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-base">Data Privacy Addendum</p>
                              <p className="text-sm text-on-surface-variant mt-0.5">V1.1 • Legal</p>
                            </div>
                          </div>
                        </td>
                        <td className="py-5 px-6 text-sm">Nov 02, 2023</td>
                        <td className="py-5 px-6">
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-[#fef7e0] text-[#b06000]">Impending</span>
                        </td>
                        <td className="py-5 px-6 text-right">
                          <button onClick={() => setEditingPolicy('data-privacy')} className="p-2 rounded-lg text-outline-variant hover:text-primary hover:bg-primary-container/10 transition-colors">
                            <Pencil size={20} />
                          </button>
                        </td>
                      </tr>
                      ...
                      <tr className="group hover:bg-surface-container-highest/30 transition-colors border-b border-surface-container-highest/50 last:border-0">
                        <td className="py-5 px-6">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-base text-on-surface-variant">2022 Office Re-entry Plan</p>
                              <p className="text-sm text-outline-variant mt-0.5">V1.0 • Operations</p>
                            </div>
                          </div>
                        </td>
                        <td className="py-5 px-6 text-sm text-on-surface-variant">Jan 15, 2022</td>
                        <td className="py-5 px-6">
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-surface-container-high text-on-surface-variant">Expired</span>
                        </td>
                        <td className="py-5 px-6 text-right">
                          <button onClick={() => setEditingPolicy('office-reentry')} className="p-2 rounded-lg text-outline-variant hover:text-primary hover:bg-primary-container/10 transition-colors">
                            <Pencil size={20} />
                          </button>
                        </td>
                      </tr>
