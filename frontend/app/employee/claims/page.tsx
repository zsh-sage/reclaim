...
function FileCard({ file, index, isActive, onSelect, onRemove, onRename }: FileCardProps) {
  ...
  return (
    <div
      onClick={onSelect}
      className={`flex items-center gap-3 rounded-xl px-3 py-2.5 cursor-pointer transition-all duration-150 group ${
        isActive
    ...
    >
      ...
      {/* Index badge */}
      <span className={`text-[11px] font-bold px-2 py-0.5 rounded-full font-label shrink-0 transition-colors ${
  ...
  return (
    <>
      ...
      <div
        ...
        className={`hidden md:flex border-2 border-dashed rounded-2xl flex-col items-center justify-center py-9 px-6 text-center cursor-pointer transition-all duration-200 group ${
          dragging
