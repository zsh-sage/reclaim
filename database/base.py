"""
This file contains the SQLModel class definitions for the database tables.
"""
...
from sqlmodel import Field, SQLModel, Column, String, Text, Integer, Boolean, DateTime
