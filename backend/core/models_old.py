...
class SupportingDocument(SQLModel, table=True):
    ...
    type: str = Field(sa_column=Column(String)) # file type pdf/jpeg
    is_main: bool = Field(default=True, sa_column=Column(Boolean)) # dead field
    document_class: str = Field(default="RECEIPT", sa_column=Column(String)) # dead field
